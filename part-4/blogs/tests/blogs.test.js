...
describe('total likes', () => {
    ...
    test('of empty list is zero ', () => {
        assert.strictEqual(listHelper.sumOfLikes([]), 0)
    })
    ...
    test('of a bigger list is calculated right', () => {
        const result = listHelper.sumOfLikes(listWithManyBlogs)
...
describe('favorite likes', () => {
    ...
    test('of one blog entry is equal to itself', () => {
        assert.deepStrictEqual(listHelper.favoriteBlog(listWithOneBlog), listWithOneBlog[0])
    })

    test('of many entries equal to the highest number of likes', () => {
...
describe('most blogs', () => {
    test('of many entries equal to the highest number of blogs', () => {
        assert.deepStrictEqual(
            listHelper.mostBlogs(authorsWithManyBlogs), 
            {author: "Edsger W. Dijkstra", blogs: 12})
    })
})
